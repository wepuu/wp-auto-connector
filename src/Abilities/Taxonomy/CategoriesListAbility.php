<?php
/**
 * Phase 1.2.4 categories-list ability.
 *
...
/**
 * Registers the bounded, read-only categories-list ability.
 */
final class CategoriesListAbility {
	public const NAME = 'wp-auto/categories-list';
	...
	public function execute( $input = array() ) {
		return ( new TaxonomyReadService() )->list_categories( $input );
	}
	...
	/**
	 * Return the exact category-list output contract.
	 *
	 * @return array<string, mixed>
	 */
	private function output_schema(): array {
		...
		return $this->envelope_schema( $item_properties );
	}

	/**
	 * Build the shared strict taxonomy envelope schema.
	 *
	 * @param array<string, mixed> $item_properties Exact item properties.
	 * @return array<string, mixed>
	 */
	private function envelope_schema( array $item_properties ): array {
		return array(
			'type'                 => 'object',
			'additionalProperties' => false,
			'properties'           => array(
