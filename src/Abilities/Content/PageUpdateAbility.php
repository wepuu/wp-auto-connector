<?php
/**
 * Phase 1.3.2 page-update ability.
 *
...
/**
 * Registers the capability-aware Page Update ability.
 */
final class PageUpdateAbility {
	public const NAME = 'wp-auto/page-update';
	...
	public function execute( $input ) {
		return ( new ContentMutationService() )->update_page_draft( $input );
	}

	/** Require the actual Page edit baseline capability. */
	public function check_permission(): bool {
		return ( new ContentMutationService() )->can_update( 'page' );
	}
}
