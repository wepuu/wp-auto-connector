...
final class PageCreateDraftAbility {
	...
	public function register_ability(): void {
		...
		wp_register_ability(
			self::NAME,
			array(
				'label'               => __( 'WP-Auto Page Create Draft', 'wepuu-auto-connector' ),
				'description'         => __( 'Creates one root WordPress page draft with a persistent idempotency key.', 'wepuu-auto-connector' ),
