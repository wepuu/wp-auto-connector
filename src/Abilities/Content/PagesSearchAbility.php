<?php
/**
 * Phase 1.2.3 pages-search ability.
 *
...
/**
 * Registers the bounded, permission-aware pages-search ability.
 */
final class PagesSearchAbility {
	public const NAME = 'wp-auto/pages-search';
	...
	public function register_ability(): void {
		...
		wp_register_ability(
			self::NAME,
			array(
				'label'               => __( 'WP-Auto Pages Search', 'wepuu-auto-connector' ),
				'description'         => __( 'Searches readable WordPress pages using bounded pagination.', 'wepuu-auto-connector' ),
	...
	public function execute( $input = array() ) {
		return ( new ContentReadService() )->search_pages( $input );
	}
