...
- Phase 1.5.0 was documentation-only and kept the exact eighteen-tool runtime. The sealed Phase 1.5.1 Category Create, Phase 1.5.2 Tag Create, and Phase 1.5.3 assignment checkpoints add exactly three tools, producing the exact twenty-one-tool runtime.
