...
The authoritative contract is `docs/PHASE_1_3_MUTATION_CONTRACTS.md`; the accepted mutation safety decision is `docs/ADR-002-MUTATION-SAFETY.md`. Phase 1.3.0, Phase 1.3.1, and Phase 1.3.2.0 are complete and formally sealed on `main`. Phase 1.3.2 is the next active implementation checkpoint, Phase 1.3 is not complete, and only the two validated Create Draft tools are currently exposed.
