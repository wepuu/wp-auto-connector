<?php
/**
 * Post-get ability contract tests.
 *
 ...
 */
final class PostGetAbilityTest extends TestCase {
	/**
	...
	public function test_registers_on_the_abilities_api_hook(): void {
		$ability = new PostGetAbility();
		$ability->register();

		self::assertSame( 'wp-auto/post-get', PostGetAbility::NAME );
	...
	public function test_registration_has_the_frozen_contract(): void {
		( new PostGetAbility() )->register_ability();
		...
		self::assertSame( PostGetAbility::NAME, $registration['name'] );
